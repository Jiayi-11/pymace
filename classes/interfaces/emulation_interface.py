...
class Socket():
    ...
    """
    def __init__(self, corenodes, wlans, session, modelname, digest, semaphore, pymace, callback, networks, macenodes, daemon):
        """_summary_
        ...
        @self.socketio.on('stop', namespace='/sim')
        def test_disconnect():
            """_summary_
            """
            self.shutdown()
